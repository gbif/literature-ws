...
@OpenAPIDefinition(
  ...
  @Info(
    ...
    version = "v1",
    description = "This API enables you to search for literature indexed by GBIF, including peer-reviewed " +
  ...
  @Parameters(
    value = {
      ...
      @Parameter(
        ...
        description = "Country or area of focus of study. Country codes are listed in our " +
      ...
      @Parameter(
        ...
        description = "Country or area of institution with which author is affiliated. Country codes are listed in our " +
          "[Country enum](https://api.gbif.org/v1/enumeration/country)." +
          REPEATED,
        array = @ArraySchema(schema = @Schema(implementation = Country.class)),
        in = ParameterIn.QUERY,
      ...
      @Parameter(
        name = "doi",
        description = "Digital Object Identifier (DOI) of the literature item." +
          REPEATED,
        array = @ArraySchema(schema = @Schema(implementation = String.class)),
        in = ParameterIn.QUERY,
        explode = Explode.TRUE),
      ...
      @Parameter(
        ...
        description = "GBIF download referenced in publication." +
          REPEATED,
        array = @ArraySchema(schema = @Schema(implementation = String.class)),
        in = ParameterIn.QUERY,
        explode = Explode.TRUE),
      ...
      @Parameter(
        name = "gbifNetworkKey",
        description = "GBIF network referenced in publication." +
          REPEATED,
        schema = @Schema(implementation = UUID.class),
        in = ParameterIn.QUERY,
        explode = Explode.TRUE),
      ...
      @Parameter(
        name = "gbifTaxonKey",
        description = "Key(s) from the GBIF backbone of taxa that are the focus of a paper." +
          REPEATED,
        array = @ArraySchema(schema = @Schema(implementation = Integer.class)),
        in = ParameterIn.QUERY,
        explode = Explode.TRUE),
      ...
      @Parameter(
        name = "year",
        description = "Year of publication.  This can be a single range such as " +
